...
class Classifier(pl.LightningModule):
    def __init__(self, backbone_name, num_frames, num_classes, head="linear", lr=1e-6, 
        ...
        if head == "linear":
            ...
            self.head = nn.Sequential(
                ...
                nn.Linear(self.video_backbone.get_video_level_embed_dim(), num_classes), # By default just repeat the video_level_embed_dim
            )
        else:
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train_acc", train_acc, batch_size=batch_size, on_step=False, on_epoch=True)
        return loss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("val_acc", val_acc, batch_size=batch_size, on_step=False, on_epoch=True)
        return loss
