...
train_df = combined_df[: int(len(combined_df) * 0.8)]
val_df = combined_df[int(len(combined_df) * 0.8) : int(len(combined_df) * 0.9)]
test_df = combined_df[int(len(combined_df) * 0.9) :]
